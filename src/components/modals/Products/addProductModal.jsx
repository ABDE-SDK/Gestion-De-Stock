...
export default function AddProductModal({ onAdd, onClose, suppliers }) {
  return createPortal(
      ...
      <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
        ...
        <form onSubmit={onAdd} className="space-y-4">
          ...
          <div>
            ...
            <select name="supplier_id" required className="mt-1 w-full rounded border border-gray-300 bg-white px-3 py-2 text-sm focus:border-blue-500 focus:outline-none">
